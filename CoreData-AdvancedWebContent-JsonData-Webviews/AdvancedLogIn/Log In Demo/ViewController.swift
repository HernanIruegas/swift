...
class ViewController: UIViewController {
    ...
    @IBAction func logOut(_ sender: AnyObject) {
        ...
        //1: we need to delete the user info. from CoreData
    ...
    @IBAction func logIn(_ sender: AnyObject) {
        ...
        if isLoggedIn {//if user is logged in we want to update its existing username
        ...
        } else {//if user is not logged in we want to save its existing username

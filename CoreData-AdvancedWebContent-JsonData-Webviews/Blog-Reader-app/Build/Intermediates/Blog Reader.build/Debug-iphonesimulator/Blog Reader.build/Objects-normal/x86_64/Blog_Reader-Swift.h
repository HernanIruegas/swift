...
SWIFT_CLASS("_TtC11Blog_Reader11AppDelegate")
...
SWIFT_CLASS("_TtC11Blog_Reader20DetailViewController")
@interface DetailViewController : UIViewController
@property (nonatomic, strong) IBOutlet UIWebView * _Null_unspecified webView;
- (void)configureView;
- (void)viewDidLoad;
- (void)didReceiveMemoryWarning;
@property (nonatomic, strong) Event * _Nullable detailItem;
...
@interface Event (SWIFT_EXTENSION(Blog_Reader))
@property (nonatomic, copy) NSString * _Nullable content;
@property (nonatomic, copy) NSString * _Nullable published;
...
SWIFT_CLASS("_TtC11Blog_Reader20MasterViewController")
...
- (void)configureCell:(UITableViewCell * _Nonnull)cell withEvent:(Event * _Nonnull)event;
@property (nonatomic, readonly, strong) NSFetchedResultsController<Event *> * _Nonnull fetchedResultsController;
@property (nonatomic, strong) NSFetchedResultsController<Event *> * _Nullable _fetchedResultsController;
...
- (void)controller:(NSFetchedResultsController<id <NSFetchRequestResult>> * _Nonnull)controller didChange:(id _Nonnull)anObject at:(NSIndexPath * _Nullable)indexPath for:(NSFetchedResultsChangeType)type newIndexPath:(NSIndexPath * _Nullable)newIndexPath;

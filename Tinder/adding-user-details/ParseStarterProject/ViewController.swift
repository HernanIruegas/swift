...
class ViewController: UIViewController {
    ...
    @IBAction func signupOrLogin(_ sender: AnyObject) {
        ...
        self.errorLabel.text = nil // Added after video — clears old error message before attempting new action
        ...
        /*******this code allows anyone to write to an object in parse***********************/
    ...
    //if the user is already logged in, show him the next view

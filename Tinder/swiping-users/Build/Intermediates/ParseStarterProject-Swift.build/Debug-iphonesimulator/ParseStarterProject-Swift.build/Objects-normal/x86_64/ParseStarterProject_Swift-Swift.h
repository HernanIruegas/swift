...
SWIFT_CLASS("_TtC25ParseStarterProject_Swift21SwipingViewController")
...
@property (nonatomic, copy) NSString * _Nonnull displayedUserID;
...
- (IBAction)updateProfileImage:(id _Nonnull)sender;
...
@property (nonatomic, strong) IBOutlet UISwitch * _Null_unspecified interestedInSwitch;
...
/**
  <em>if the user already has info, it goes to the swiping; if not, it goes to the info.</em>******************
*/
- (void)redirectUser;
- (void)viewDidLoad;
- (void)didReceiveMemoryWarning;

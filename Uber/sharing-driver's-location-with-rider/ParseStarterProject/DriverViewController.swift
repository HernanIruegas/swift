   ...
   override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
    ...
    func locationManager(_ manager: CLLocationManager, didUpdateLocations locations: [CLLocation]) {
        ...
        if let location = manager.location?.coordinate {
            ...
            //we save our driver's location in parse
            
            let driverLocationQuery = PFQuery(className: "DriverLocation")//we create a new class name
            ...
            driverLocationQuery.findObjectsInBackground(block: { (objects, error) in
                ...
                //we need to save the driver's location in the riderRequest object
                
                if let driverLocations = objects {
                    
                    //if a location already exists for our driver, we delete it
                ...
                //now we update our driver's location in parse

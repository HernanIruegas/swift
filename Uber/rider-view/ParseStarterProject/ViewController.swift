...
class ViewController: UIViewController {
            ...
            if signUpMode {
                ...
                user.signUpInBackground(block: { (success, error) in
                    ...
                    if let error = error {
                        ...
                        /*****we perform the segue to another view***********************/
                        ...
                        if let isDriver = PFUser.current()?["isDriver"] as? Bool {
                            ...
                            if isDriver {
                                ...
                                //if the user is a rider, show him the rider view controller
    ...
    @IBAction func switchSignupMode(_ sender: AnyObject) {
        ...
        if signUpMode {
            ...
            //if the user wants to log in, there is no need to show him the driver or rider switch; so we need to hide them
            ...
            //the user needs to see the options of rider or driver in order to sign up correctly

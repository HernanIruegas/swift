...
class UserTableViewController: UITableViewController {
    ...
    /*********************/
    //this func. contains code that was previously in viewDidLoad, but we moved it here; it is to refresh the content of the table
    /*********************/
    func refresh() {
    ...
    /*********************/
        ...
        //gets called when pull to refresh is activated
